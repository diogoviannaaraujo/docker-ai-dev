...
# Start JupyterLab
exec jupyter lab --ip=0.0.0.0 --port=8888 --ServerApp.allow_origin=* --ServerApp.allow_remote_access=True --ServerApp.disable_check_xsrf=True --no-browser --allow-root